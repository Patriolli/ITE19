...
// Fetch available vehicles for the current agent from the vehicles_for_sale table
$vehicleQuery = "SELECT brand, model, COUNT(*) as quantity FROM vehicles_for_sale WHERE status = 'available' GROUP BY brand, model";
...
<head>
    ...
    <title>List Available Vehicles</title>
